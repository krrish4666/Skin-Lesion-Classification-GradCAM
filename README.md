# Skin-Lesion-Classification-GradCAM
...
# 2. Open and run the main training notebook
...
│   └── best_model.keras
├── skin_cancer_classification.ipynb  # Main training & prediction notebook
├── kaggle.json                # Your Kaggle API credentials (not in repo!)
├── requirements.txt
└── README.md
```

**Note:** 
- `kaggle.json` and `skin_cancer_data/` are not included in the repository
- `models/` folder is created automatically when you save your trained model
